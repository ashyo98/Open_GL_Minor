...
void Happy::happyFace_2()
{
	...
	khushi.drawArc(SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2 - 20, 0, 41, 200, 340, 50); // mouth 
	khushi.drawArc(SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2 - 20, 0, 42, 200, 340, 50); // mouth 
	khushi.drawArc(SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2 - 20, 0, 43, 200, 340, 50); // mouth 
}
