...
void Angry::angryFace_3()
{
	...
	gussa.drawCircle(SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2, 0, 120, 90, 1, 1);  //  face
	glColor3d(0, 0, 0);
	gussa.drawCircle(SCREEN_WIDTH / 2 + 38, SCREEN_HEIGHT / 2 + 20, 0, 20, 100, 0.7, 1); // right
	gussa.drawCircle(SCREEN_WIDTH / 2 - 40, SCREEN_HEIGHT / 2 + 20, 0, 20, 100, 0.7, 1); // left
	glColor3f(0.0f, 0.0f, 0.0f);

	gussa.drawLine(SCREEN_WIDTH / 2 + 18, SCREEN_HEIGHT / 2 + 25, SCREEN_WIDTH / 2 + 68, SCREEN_HEIGHT / 2 + 45); // right eyebrow-1
	gussa.drawLine(SCREEN_WIDTH / 2 + 18, SCREEN_HEIGHT / 2 + 26, SCREEN_WIDTH / 2 + 68, SCREEN_HEIGHT / 2 + 46); // right eyebrow-1
	gussa.drawLine(SCREEN_WIDTH / 2 + 18, SCREEN_HEIGHT / 2 + 27, SCREEN_WIDTH / 2 + 68, SCREEN_HEIGHT / 2 + 47); // right eyebrow-1
	gussa.drawLine(SCREEN_WIDTH / 2 + 18, SCREEN_HEIGHT / 2 + 28, SCREEN_WIDTH / 2 + 68, SCREEN_HEIGHT / 2 + 48); // right eyebrow-1
	gussa.drawLine(SCREEN_WIDTH / 2 + 18, SCREEN_HEIGHT / 2 + 29, SCREEN_WIDTH / 2 + 68, SCREEN_HEIGHT / 2 + 49); // right eyebrow-1
	gussa.drawLine(SCREEN_WIDTH / 2 + 18, SCREEN_HEIGHT / 2 + 30, SCREEN_WIDTH / 2 + 68, SCREEN_HEIGHT / 2 + 50); // right eyebrow-1
	gussa.drawLine(SCREEN_WIDTH / 2 + 18, SCREEN_HEIGHT / 2 + 25, SCREEN_WIDTH / 2 + 18, SCREEN_HEIGHT / 2 + 43); // right eyebrow-2
	gussa.drawLine(SCREEN_WIDTH / 2 + 17, SCREEN_HEIGHT / 2 + 26, SCREEN_WIDTH / 2 + 17, SCREEN_HEIGHT / 2 + 42); // right eyebrow-2
	gussa.drawLine(SCREEN_WIDTH / 2 + 16, SCREEN_HEIGHT / 2 + 27, SCREEN_WIDTH / 2 + 16, SCREEN_HEIGHT / 2 + 41); // right eyebrow-2

	gussa.drawLine(SCREEN_WIDTH / 2 - 18, SCREEN_HEIGHT / 2 + 25, SCREEN_WIDTH / 2 - 68, SCREEN_HEIGHT / 2 + 45); // left eyebrow-1
	gussa.drawLine(SCREEN_WIDTH / 2 - 18, SCREEN_HEIGHT / 2 + 26, SCREEN_WIDTH / 2 - 68, SCREEN_HEIGHT / 2 + 46); // left eyebrow-1
	gussa.drawLine(SCREEN_WIDTH / 2 - 18, SCREEN_HEIGHT / 2 + 27, SCREEN_WIDTH / 2 - 68, SCREEN_HEIGHT / 2 + 47); // left eyebrow-1
	gussa.drawLine(SCREEN_WIDTH / 2 - 18, SCREEN_HEIGHT / 2 + 28, SCREEN_WIDTH / 2 - 68, SCREEN_HEIGHT / 2 + 48); // left eyebrow-1
	gussa.drawLine(SCREEN_WIDTH / 2 - 18, SCREEN_HEIGHT / 2 + 29, SCREEN_WIDTH / 2 - 68, SCREEN_HEIGHT / 2 + 49); // left eyebrow-1
	gussa.drawLine(SCREEN_WIDTH / 2 - 18, SCREEN_HEIGHT / 2 + 30, SCREEN_WIDTH / 2 - 68, SCREEN_HEIGHT / 2 + 50); // left eyebrow-1
	gussa.drawLine(SCREEN_WIDTH / 2 - 18, SCREEN_HEIGHT / 2 + 25, SCREEN_WIDTH / 2 - 18, SCREEN_HEIGHT / 2 + 43); // left eyebrow-2
	gussa.drawLine(SCREEN_WIDTH / 2 - 17, SCREEN_HEIGHT / 2 + 26, SCREEN_WIDTH / 2 - 17, SCREEN_HEIGHT / 2 + 42); // left eyebrow-2
	gussa.drawLine(SCREEN_WIDTH / 2 - 16, SCREEN_HEIGHT / 2 + 27, SCREEN_WIDTH / 2 - 16, SCREEN_HEIGHT / 2 + 41); // left eyebrow-2
	...
	gussa.drawArc(xc, yc, 0, r1 - 1, theta1, theta2, 50); //mouth
	gussa.drawArc(xc, yc, 0, r1 - 2, theta1, theta2, 50); //mouth
	gussa.drawArc(xc, yc, 0, r1 - 3, theta1, theta2, 50); //mouth
	gussa.drawArc(xc, yc, 0, r1 - 4, theta1, theta2, 50); //mouth
}
